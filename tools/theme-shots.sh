#!/usr/bin/env bash
# A screenshot of merl in every shipped theme, for the README gallery. Needs vhs, Python with
# Pillow and a release build:
#
#   cargo build --release && tools/theme-shots.sh
#
...
# The names, in picker order, straight from the THEMES table.
